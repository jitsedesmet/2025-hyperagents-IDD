...
interfaces which depend on intermediate resources, where the manipulation of one resource can have consequences on the manipulation of another,
...
Left is a classical interface description, describing the endpoints but not how data flows between them,
while right shows a description that also describes the flow of data between the endpoints.
