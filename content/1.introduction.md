...
Example interface description <span class="comment" data-author="RT">It's not really a description yet in this figure, right? I'd call it something else, either abstract something or use case.</span> of a pet doctors database containing owners with their pets.
...
We include four endpoint families:<span class="comment" data-author="RT">Minor nit: a bit confusing that you introduce them from right to left in the figure. Left to right would make more sense.</span>
