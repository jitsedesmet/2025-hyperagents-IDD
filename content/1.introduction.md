...
autonomous systems capable of acting on behalf of individuals.<span class="comment" data-author="RT">Good to build on the hype here. But I wonder if we can not implicitly mention somehow that this is a revamp of the original Semantic Web vision.</span>
...
A write/ call <span class="comment" data-author="RT">Do you mean write operation?</span> to one endpoint can have various consequences on different resources.
...
we argue for the need of a framework that algebraically describes (think SPARQL algebra) <span class="comment" data-author="RT">Most readers won't know SPARQL algebra. This is usually only known to engine developers. Either remove the (), or we need to come up with another way to explain it.</span> the relationship between write operations,
...
<span class="comment" data-author="RT">Uppercase POST, GET, PATCH. And WebSocket.</span>
<span class="comment" data-author="RT">Instead of explaining what this figure shows (the text below already explains it), I'd instead explain the message you want it to convey. I guess this is something along the lines of all db info being described, including how it can be manipulated.</span>
</figcaption>
</figure>
